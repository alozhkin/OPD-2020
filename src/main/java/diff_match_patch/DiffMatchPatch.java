 ...
 *
 * Changed visibility of methods, added linesToWords, linesToWordsMurge and getNewWords methods, renamed class and file
 * Modifications copyright 2020 Andrey Lozhkin
 */
...
public class DiffMatchPatch {
  ...
  // Input strings have to start and end with '\s'
  public Collection<String> getNewWords(String text1, String text2) {
    var a = diff_linesToWords(text1, text2);
    var lineText1 = a.chars1;
    var lineText2 = a.chars2;
    var lineArray = a.lineArray;
    var diffs = diff_main(lineText1, lineText2, false);
    // despite the name, the diff_charsToLines function work fine in word-mode.
  ...
  public LinesToCharsResult diff_linesToWords(String text1, String text2) {
    ...
    String chars1 = diff_linesToWordsMunge(text1, lineArray, lineHash, 40000);
    String chars2 = diff_linesToWordsMunge(text2, lineArray, lineHash, 65535);
...
//  private static final char[] charsToFind = new char[] {' ', '<', '>'};
//
//  private int indexOf(String value, int fromIndex) {
...
//        if (value.charAt(i) == charsToFind[j]) {
//          return i;
//        }
//      }
//    }
